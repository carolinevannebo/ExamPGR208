...
class DBHelper(private val appDatabase: AppDatabase) {
    override suspend fun getAllRecipes(): List<RecipeItem> = appDatabase.recipeItemDao().getAllRecipes()
    override suspend fun getAllRecipeLists(): List<RecipeList> = appDatabase.recipeListDao().getAllRecipeLists()
    override suspend fun insertAllRecipes(recipeItems: List<RecipeItem>) = appDatabase.recipeItemDao().insertAll(recipeItems)
    override suspend fun insertAllRecipeLists(recipeLists: List<RecipeList>) = appDatabase.recipeListDao().insertAll(recipeLists)
}
/*
